<?php
  ...
  if(isset($_SESSION['u_usuario'])){
    ...
    if(!empty($_POST))
    {
        $valor = $_POST['campo'];
        if(!empty($valor)){
            $where = "WHERE nombre_carrera LIKE '%$valor%' ";
        }
    }
    $sql = "SELECT * FROM carrera ca INNER JOIN facultad fa ON ca.facultad_id = fa.id $where  order by `nombre_carrera` ASC ;";
    ...
    <!-- breadcrum o miga de pan -->
      <div class="container">               
        <ol class="breadcrumb">
          ...
          <li><a href="#">Carreras registrados</a></li>     
        </ol>
      </div>
  </div>  
              ...
              <tbody>
                  ...
                  while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                      <tr>
                          ...
                          <td><a href="modificar_carrera.php?id=<?php echo $row['idcarrera']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                          <td><a href="#" data-href="eliminar_carrera.php?id=<?php echo $row['idcarrera']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
                      </tr>
                  <?php }?>
              </tbody>
          </table>
